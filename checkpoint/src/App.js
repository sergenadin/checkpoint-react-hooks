...
import MovieDetail from './Componments/MovieDetail';
  ...
  const [movies, setMovies] = useState([
    {
      ...
      trailerURL: 'https://www.youtube.com/embed/gRmnwAqwq3A', // Exemple de lien vers une bande-annonce YouTube
      rating: '4.5'
    },
    {
    ...
    },
    {
      ...
      trailerURL: 'https://www.youtube.com/embed/YVseLsV2tZ8',
      rating: '4.7'
    },
    {
      ...
      trailerURL: 'https://www.youtube.com/embed/syBo8scLoS0',
      rating: '4.6'
    },
  ]);

  const [newMovie, setNewMovie] = useState({ title: '', description: '', posterURL: '', trailerURL: '', rating: '' });
      ...
      <div className='mt-5'>
        ...
        <form>
          ...
          <div className='form-group'>
            ...
            <input type="text" value={newMovie.trailerURL} className='form-control' onChange={(e) => setNewMovie({ ...newMovie, trailerURL: e.target.value })} />
          </div>
